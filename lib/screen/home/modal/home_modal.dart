class Artical
{
  ...
  Artical articalJson(Map m1)
  {
    ...
    Artical artical = Artical(urlToImage: urlToImage,url: url,publishedAt: publishedAt,description: description,content: content,author: author,title: title,source: source);
